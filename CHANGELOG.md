...
- The UDP ASSOCIATE idle timeout is no longer refreshed by traffic that is then
  dropped. Activity was marked *before* a datagram was validated, so a spoofed or
  ...
  idle timer is now refreshed only after a datagram is fully validated and
